...
import projeto.trabalho.poligonos.AlgPreeAGeo.PoligonoAGeo;

import java.awt.*;

public class PoligonoBoundaryfill {
    private int x;
    private int y;
    ...
    public PoligonoBoundaryfill(int x, int y, int diameter, Color color) {
        this.x = x;
        this.y = y;
